...
import { BrainCircuit, Mail, Lock, ArrowRight, Eye, EyeOff, ShieldCheck, Sparkles } from "lucide-react";
import NeuralBackground from "@/components/NeuralBackground";

export default function LoginPage() {
  const { setGuestMode, login, isAuthenticated, isGuestMode, loading: authLoading } = useAuth();
        ...
        >
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-xs font-mono mt-1 tracking-widest uppercase text-cyan-400">
              CognitoShield AI · Biological Integrity Access
            </p>
            ...
            <div className="mt-3 px-4 py-2 rounded-full bg-cyan-500/5 border border-cyan-500/20 max-w-xs flex items-center justify-center gap-2">
              ...
              <p className="text-[11px] font-mono text-gray-300 italic">
                "Continuous biological telemetry safeguarding focus & rhythm."
              </p>
            </div>
          </div>
          ...
          <div className="bg-black/70 backdrop-blur-2xl border border-cyan-500/25 rounded-3xl p-6 sm:p-8 space-y-5 shadow-[0_0_50px_rgba(0,217,255,0.08)]">
            ...
            <form onSubmit={handleLogin} className="space-y-4" noValidate>
              ...
              <div className="space-y-1.5">
                <label htmlFor="login-email" className="block text-xs font-mono tracking-wider uppercase text-gray-400">
                  Email Address
                </label>
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  <label htmlFor="login-password" className="block text-xs font-mono tracking-wider uppercase text-gray-400">
                    Password
                  </label>
                  <Link href="/forgot-password" className="text-[11px] font-mono text-cyan-400 hover:underline">
                    Forgot password?
                  </Link>
                </div>
                <div className="relative">
